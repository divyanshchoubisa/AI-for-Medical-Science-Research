...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: Batch size, coronal, sagittal and axial axis
    ...
    def validate(self):
        """
        This method runs        validation cycle, using same metrics      Train method. Note that model needs to be switched to eval
